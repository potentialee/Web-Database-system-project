...
<head>
	...
	<title>로도스 플레임 왕국 데이터 베이스 페이지 - 상회 정보 수정 결과</title>
</head>
<body>
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String update_value_single = "UPDATE magicfirm_information SET password ='"+ password +"', businessname = '"+ businessname +"', adress = '"+ adress +"', representative ='"+ representative +"', permissionclass = "+ permissionclass +" , money= "+ money +" WHERE magicfirmid = "+ logined_id +" ";
