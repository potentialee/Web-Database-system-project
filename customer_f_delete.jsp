...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR" errorPage="error_common.jsp" %>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String delete_value_magicfirm = "DELETE FROM partner_information WHERE customerid = "+ logined_id +" AND magicfirmid = "+ magicfirmid +" ";
				...
				stmt.executeUpdate(delete_value_magicfirm);
				...
				%>
						<div class="container">
							...
							<div class="p-3 mb-2 bg-light text-dark rounded border" id="content_wrap"> 
								<div class="alert alert-primary" role="alert"> 해당 상회를 거래처 목록에서 해지하였습니다.
								</div>
								<div>
									<h2><strong> 해지 처리 성공 </strong></h2>
									<p><strong> 귀하의 요청이 정상적으로 다음과 같이 수행되었습니다. : </strong></p>
									<p><strong> <%=delete_value_magicfirm%> </strong> </p>	
								</div>
