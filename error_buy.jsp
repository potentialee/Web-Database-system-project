...
<body>
	<div class="container">
		...
		<div class="p-3 mb-2 bg-light text-dark rounded border" id="content_wrap">
			<p>구매량을 입력하지 않고 구매 버튼을 누르셨거나, 다른 칸에 대한 버튼을 입력하신것 같습니다. 이전 페이지로 돌아갑니다.</p>
			<button type="button" class="btn btn-secondary btn-lg" onClick="history.go(-1)">로그인 페이지로 돌아가기</button>
		</div>
	</div>
</body>
</html>