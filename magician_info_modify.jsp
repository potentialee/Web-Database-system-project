...
<title>로도스 플레임 왕국 데이터 베이스 페이지 - 마법사 정보 수정</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="p-3 mb-2 bg-light text-dark rounded border">
			...
			<%-- 폼 부분 시작 --%>
			<div>
				<form action="magician_modify_result.jsp" method="post">

					<div class="form-group">
						<label> <strong>이름</strong></label> <input type="text" class="form-control" name="magicianname" value="<%=magicianname %>" required>
					</div>
					...
					<div class="form-group">
						<label> <strong>나이</strong></label> <input type="number" class="form-control" name="age" min="1" max="2135" value="<%=age %>"  required>
					</div>
					
					<div class="form-group">
						<label> <strong>종족</strong></label> <input type="text" class="form-control" name="tribe" value="<%=tribe %>" required>
					</div>
					
					<div class="form-group">
						<label> <strong>출신지</strong></label> <input type="text" class="form-control" name="hometown" value="<%=hometown %>" required>
					</div>
					
					<div class="form-group">
						<label> <strong>직업</strong></label> <input type="text" class="form-control" name="job" value="<%=job %>"  required>
					</div>
					
					<div class="form-group">
						<label> <strong>클래스</strong></label> <input type="number" class="form-control" name="magicclass" min="1" max="10" value="<%=magicclass %>"  required>
					</div>

					<div class="form-group">
						<label> <strong>마나량</strong></label> <input type="number" class="form-control" name="manacount" min="0" max="11000000"  value="<%=manacount %>" required>
					</div>
