	...
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String update_value_single = "UPDATE magic_information SET magicname = '"+ magicname +"',  magicclass = "+ magicclass +", magicexplanation = '"+ magicexplanation +"', effectivedose = "+ effectivedose +" , sellingprice = "+ sellingprice +", manaconsume= "+ manaconsume +" WHERE magicid = "+magicid+" ";
