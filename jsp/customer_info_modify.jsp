...
<%
	...
	// 로그인 마법사 정보 가져오는 쿼리
	String query = "SELECT * FROM customer_information WHERE customerid = " + logined_id + " ";
...
<title>로도스 플레임 왕국 데이터 베이스 페이지 - 고객 정보 수정</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="p-3 mb-2 bg-light text-dark rounded border">
			...
			<%-- 폼 부분 시작 --%>
			<div>
				<form action="customer_modify_result.jsp" method="post">

					<div class="form-group">
						<label> <strong>이름</strong></label> <input type="text" class="form-control" name="customername" value="<%=customername%>" required>
					</div>
					...
					<div class="form-group" id="last_form">
						<label> <strong>소지금</strong></label> <input type="number" class="form-control" name="money"  min="1000" max="20000000" value="<%=money%>" required>
					</div>
