	...
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String add_value_magicfirm = "INSERT INTO partner_information(magicfirmid, customerid) VALUES ("+magicfirmid+", "+logined_id+")";
				...
				stmt.executeUpdate(add_value_magicfirm);
				...
				%>
						<div class="container">
							...
							<div class="p-3 mb-2 bg-light text-dark rounded border" id="content_wrap"> 
								<div class="alert alert-primary" role="alert"> 해당 상회가 거래처로 등록 되었습니다. 
								</div>
								<div>
									<h2><strong> 등록 처리 성공 </strong></h2>
									<p><strong> 귀하의 요청이 정상적으로 다음과 같이 수행되었습니다. : </strong></p>
									<p><strong> <%=add_value_magicfirm%> </strong> </p>	
								</div>
