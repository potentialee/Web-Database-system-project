	...
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String delete_value_magician = "DELETE FROM belongto_information WHERE magicianid = "+ magicianid +" ";
				...
				stmt.executeUpdate(delete_value_magician);
				...
				%>
						<div class="container">
							...
							<div class="p-3 mb-2 bg-light text-dark rounded border" id="content_wrap"> 
								<div class="alert alert-primary" role="alert"> 해당 마법사가 상회에서 추방되었습니다.
								</div>
								<div>
									<h2><strong> 추방 처리 성공 </strong></h2>
									<p><strong> 귀하의 요청이 정상적으로 다음과 같이 수행되었습니다. : </strong></p>
									<p><strong> <%=delete_value_magician%> </strong> </p>	
								</div>
