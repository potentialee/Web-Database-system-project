...
<body>
	<%
		...
		try {
			...
			String password = request.getParameter("firm_password");

			String redirect = null;

			conn = DriverManager.getConnection(jdbcDriver, dbUser, dbPass);

			String query = "SELECT * FROM magicfirm_information where magicfirmid = ?";
			preStmt = conn. prepareStatement(query);

			preStmt.setInt(1, firmid);
