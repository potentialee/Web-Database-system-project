	...
	<%
		...
		int logined_id = (Integer) (session.getAttribute("logined_id"));
			...
			try {
				...
				String update_value_single = "UPDATE magician_information SET password ='"+ password +"', magicianname = '"+ magicianname +"',  age = "+ age +", tribe = '"+ tribe +"', hometown ='"+ hometown +"', job = '"+ job +"', magicclass = "+ magicclass +" , manacount = "+ manacount +", money= "+ money +" WHERE magicianid = "+ logined_id +" ";
